...
def animate_scene_tracking(nusc, scene_trackers_results, all_scenes_associations, scene_name, interval=100):
    ...
    Per ciascun frame viene visualizzata l'immagine della camera con i tracker tracciati sopra.
    """
...
for scene_idx, scene in enumerate(nusc.scene):
    ...
    while sample_token:
        ...
        if cam_token is None or lidar_token is None:
            ...
            continue
        points_2d = get_calibrated_points(explorer, pointsensor_token, camera_token)
...
for scene_name, frames in all_scenes_associations.items():
    ...
    for frame in frames:
        ...
        #  Data association tracker e misure 
...
# %%
# Esempio di animazione per il tracking 
scene_name=4
